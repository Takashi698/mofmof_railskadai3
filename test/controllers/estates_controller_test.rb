...
class EstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estate" do
    assert_difference('Estate.count') do
      post estates_url, params: { estate: { address: @estate.address, age: @estate.age, name: @estate.name, note: @estate.note, rent: @estate.rent } }
    end
  ...
  test "should update estate" do
    patch estate_url(@estate), params: { estate: { address: @estate.address, age: @estate.age, name: @estate.name, note: @estate.note, rent: @estate.rent } }

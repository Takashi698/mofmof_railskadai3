class EstatesController < ApplicationController
  ...
  private
    ...
    def estate_params
      params.require(:estate).permit(:name, :rent, :address, :age, :note, stations_attributes: [:id, :station_line, :station_name, :walking_time, :estate_id])
    end
end